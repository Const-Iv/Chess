...
- Нельзя реализовывать изменение, которое противоречит `.memory-bank/product-charter.md`, смешивает Школу ассистентов с другими идеями встречи, ослабляет deterministic QA, safe task flow или source-of-truth governance.
...
- Raw transcript `Docs/product-discovery/2026-04-03-assistant-selection-transcript.raw` нельзя редактировать или пересказывать как замену источнику; он хранит verbatim-фрагмент встречи.
- До подтверждения гипотезы не фиксировать runtime, stack, коммерческую модель, governance/runtime ownership или capability decisions как готовые продуктово-технические решения.
